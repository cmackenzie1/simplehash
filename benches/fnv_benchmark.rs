...
use simplehash::{fnv1_32, fnv1a_32, fnv1_64, fnv1a_64};
...
fn bench_realistic_inputs(c: &mut Criterion) {
    ...
    for input in inputs {
        ...
        group.bench_with_input(BenchmarkId::new("FNV1-32", &input_name), &data, |b, data| {
            b.iter(|| fnv1_32(black_box(data)));
        });
        
        group.bench_with_input(BenchmarkId::new("FNV1a-32", &input_name), &data, |b, data| {
            b.iter(|| fnv1a_32(black_box(data)));
        });
        
        group.bench_with_input(BenchmarkId::new("FNV1-64", &input_name), &data, |b, data| {
            b.iter(|| fnv1_64(black_box(data)));
        });
        
        group.bench_with_input(BenchmarkId::new("FNV1a-64", &input_name), &data, |b, data| {
            b.iter(|| fnv1a_64(black_box(data)));
        });
    }
